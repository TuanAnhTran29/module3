            ...
            <div class="col-lg-8 col-xl-6">
                <div class="card rounded-3">
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form method="post" action="/accounts?action=createStudent" class="px-md-2">

                            <div class="form-outline mb-4">
                                <input name="studentName" type="text" id="form3Example1q" class="form-control" />
                                <label class="form-label" for="form3Example1q">Name</label>
                            </div>

                            <div class="form-outline mb-4">
                                <input name="className" type="text" id="form3Example2q" class="form-control" />
                                <label class="form-label" for="form3Example2q">Class Name</label>
                            </div>
